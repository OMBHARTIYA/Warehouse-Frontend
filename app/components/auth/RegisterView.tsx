...
export default function RegisterView() {
  ...
  const validate = (data: RegisterFormData) => {
    ...
    else if (data.password.length < 6) nextErrors.password = "Password must be at least 6 characters.";
    return nextErrors;
  };
